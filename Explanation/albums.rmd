...
```{r | validate_parameters function}
#Initializes the validate parameters function, which checks if parameters are valid
validate_parameters <- function(artists_or_tracks = NULL, # Checks if its an artist or track
                                artist_or_user = NULL, # Checks if its an artist or user
                                market = NULL, # Checks what the market is
                                country = NULL, # Checks the country
                                limit = NULL, # Maximum number of wanted things
                                offset = NULL, # Index of first thing
                                locale = NULL, # Desired language
                                volume_percent = NULL, # 0 to 100 volume to set
                                time_range = NULL, # Time range of song
                                position_ms = NULL, # Checks if greater than 0
                                state = NULL, # Checks if valid state
                                include_meta_info = NULL) # Checks if meta info should be included
                                {
